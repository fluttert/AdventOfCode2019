...
namespace AdventOfCode2019.Y2019
{
    public class Day03 : IAoCDay
    {
        public string SolvePart1(string input = null)
        {
            ...
            int x = 0, y = 0;
            var wire1Coordinates = new HashSet<(int x, int y)>();
            ...
            foreach (string instruction in wire1)
            {
                ...
                for (int i = 0; i < steps; i++)
                {
                    ...
                    if (wire1Coordinates.Contains(pos))
                    {
                        doubles++;
                    }
                    wire1Coordinates.Add(pos);
                }
            }
            ...
            foreach (string instruction in wire2)
            {
                ...
                for (int i = 0; i < steps; i++)
                {
                    ...
                    if (wire1Coordinates.Contains(pos))
                    {
                        Debug.WriteLine($"Crossing at {x},{y}");
                        if (Math.Abs(x) + Math.Abs(y) < closestIntersectionDistance)
                        {
                            closestIntersectionDistance = (int)Math.Abs(x) + (int)Math.Abs(y);
                        }
                    }
                }
            }
        ...
        public string SolvePart2(string input = null)
        {
            ...
            int x = 0, y = 0;
            var wire1Coordinates = new Dictionary<(int x, int y), int>();
            ...
            foreach (string instruction in wire1)
            {
                ...
                for (int i = 0; i < steps; i++)
                {
                    ...
                    wireLength++;
                    if (!wire1Coordinates.ContainsKey(pos)) {
                        wire1Coordinates.Add(pos, wireLength);
                    }
            ...
            foreach (string instruction in wire2)
            {
                ...
                for (int i = 0; i < steps; i++)
                {
                    ...
                    {
                        Debug.WriteLine($"Crossing at {x},{y}");
                        if (wireLength + wire1Coordinates[pos] < bestSum)
                        {
                            bestSum = wireLength + wire1Coordinates[pos];
                        }
                    }
                }
            }
